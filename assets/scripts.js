let schedule = {
  ...
  "photo": {
    "hone": [
      {"time": "9:00 AM", "title": "Intro to Manual Photography", "speakers": "Clementine Mariani", "description": "", "required": "Optional: DLSR camera"},
      {"time": "10:00 AM", "title": "Intro to Lightroom", "speakers": "Kate Kim, Christian Kim", "description": "This is an entry-level (no prior experience needed!), demo-orietnated workshop on the basics of editing a RAW file on Adobe Lightroom. The lesson will cover how to read a histogram, using sliders and tools, adjusting color, and everything else you need to know to get started with post-processing; come with Lightroom Classic downloaded on your computer!", "required": "Adobe Lightroom"},
      {"time": "11:00 AM", "title": "Mobile Phonetography", "speakers": "Jessica Hsiao", "description": "The best camera is the one you have, and for many people that's their phone. In this workshop, you'll learn how to take and edit Instagram-worthy photos using just your smartphone.", "required": "Your phone, Lightroom Mobile, VSCO"}
    ],
    "explore": [
      {"time": "12:00 PM", "title": "Building Comfort with Clients", "speakers": "Vivian Tiet", "description": "Being relational with your client is the magic behind portrait photography. Whether that client is a random person, a family member, or your roommate, come learn how to capture their character in a photograph.", "required": "Any camera! Even a phone will work."},
      {"time": "1:00 PM", "title": "Photo Collages with Photoshop", "speakers": "Jago Pang", "description": "", "required": "Adobe Photoshop, Google Drive"},
      {"time": "2:00 PM", "title": "Photography Ethics", "speakers": "Christian Kim", "description": "This workshop will engage with critical thinking in an in-depth conversation on the ethics of photography before and after the shot (digital manipulation, engaging with subjects, photographing other cultures, etc.). The goal is to provide ethical literacy, giving you more tangible tools to be effective in your work while gaining access to relationships and communities in socially responsible ways.", "required": ""},
      {"time": "3:00 PM", "title": "Intro to 35mm Film", "speakers": "Calvin Tang", "description": "Film photography can feel like a daunting vintage world to enter, especially in the age of digital sensors and complex software. Come learn what you need to get started with 35mm photography!", "required": ""},
      {"time": "4:00 PM", "title": "Maintaining Your Creative Confidence and Fighting Imposter Syndrome", "speakers": "Renee Utter", "description": "", "required": ""}
    ]
  },
  "web": {
    "hone": [
    ...
    "explore": [
      ...
      {"time": "3:00 PM", "title": "Audio Visualizer with three.js", "speakers": "Alan Nguyen, Ethan Lee", "description": "", "required": "Laptop, text editor (ie. atom, vscode, sublime)"},
